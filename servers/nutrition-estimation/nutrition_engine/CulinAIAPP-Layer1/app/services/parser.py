...
from app.db.models import Ingredient, IngredientSynonym, UnitConversion
...
try:
    ...
    if isinstance(e, ImportError):
        logger.debug("spaCy not installed (optional). Install with: pip install -r requirements-nlp.txt")
    else:
